...
海外アーティストの名盤を **1曲ずつ深掘り解説** する音楽ポッドキャストの自動生成プロジェクトです。台本を用意すると、Fish Audio の TTS で音声化し、Podcast 用の RSS フィード(`docs/feed.xml`)を生成して GitHub Pages で配信します。
...
- **トーン**: 音楽好きに語りかける、熱量のある「です・ます」調の1人語り。目安は1話1曲・2,000〜3,500字。
