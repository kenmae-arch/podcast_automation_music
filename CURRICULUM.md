...
アルバム: 2003年8月4日 / Kling Klang・EMI(北米はAstralwerks) / 全12曲。前作『Electric Café』(1986)から17年ぶりのスタジオ・アルバム。自転車ロードレースのツール・ド・フランスを一枚まるごとの主題にしたコンセプト作。出発点は1983年7月の同名シングル(第1回大会から80年の節目)で、レースが100回目を迎える2003年にアルバムへ拡張された。プロデュースはRalf HütterとFlorian Schneider。ドイツのアルバム・チャートでグループ初の1位、英国21位。**創設者Florian Schneiderが参加した最後のスタジオ・アルバム**。通し軸=**走る身体を、機械の音で描く**(第9弾までの「都市の観察者」に対する新しい軸。第7弾Discoveryの電子音楽の系譜を源流側から聴き直す)。
