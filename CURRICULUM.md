...
- **第11弾**: Frank Ocean『Blonde』(2016) — 全17曲 … ⬜ **次シリーズ**(第10弾 #12 で予告済み)
...
> 音声ファイルは番組通算の連番 `episode_{連番}_{日付}.mp3`(第1弾 001〜018、第2弾 019〜030、第3弾 031〜042、第4弾 043〜059、第5弾 060〜071、第6弾 072〜092、第7弾 093〜106、第8弾 107〜116、第9弾 117〜127、第10弾 128〜)。エピソードタイトルの番号(#N)はシリーズごとにリセット。
...
# 第11弾: Frank Ocean『Blonde』(次シリーズ・未着手)

> 📣 第10弾 #12【最終回】で予告済み。**着手時に `docs/art/blonde.jpg` の追加、`albums.json`・`sync_website_data.py` への登録が必要**(第10弾と同じ手順)。
...
| # | 曲名 | ステータス | メモ |
|---|------|-----------|------|
| 1 | Nikes | ⬜ | 冒頭からピッチを大きく上げた声。誰の声か分からない状態で始まる=本作の方法論の宣言 |
| 2 | Ivy | ⬜ |  |
| 3 | Pink + White | ⬜ | Pharrell Williams参加。Beyoncéのバックグラウンド・ヴォーカルとされる |
