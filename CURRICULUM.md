...
- **第10弾**: Kraftwerk『Tour de France』(2003 / 2009 remaster) — 全12曲 … 🔄 **進行中**(#1〜#3 配信済み)
...
| 4 | Tour de France Étape 3 | ⬜ | 次回制作予定。組曲の終着(3分56秒) |
| 5 | Chrono | ⬜ | 個人タイムトライアル(クロノメトル)の略 |
| 6 | Vitamin | ⬜ | 栄養補給 |
| 7 | Aéro Dynamik | ⬜ | 2004年にシングル・カットあり(要再確認) |
