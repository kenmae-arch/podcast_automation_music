...
- **第10弾**: Kraftwerk『Tour de France』(2003 / 2009 remaster) — 全12曲 … 🔄 **進行中**(#1〜#6 配信済み)
...
# 第10弾: Kraftwerk『Tour de France』(進行中)
...
| 7 | Aéro Dynamik | ⬜ | 次回制作予定。空気抵抗。2004年にシングル・カットあり(要再確認) |
| 8 | Titanium | ⬜ | 素材=自転車のフレーム |
| 9 | Elektro Kardiogramm | ⬜ | 心電図 |
| 10 | La Forme | ⬜ | 調子・コンディション |
| 11 | Régéneration | ⬜ | 回復 |
