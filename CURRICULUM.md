...
- **第11弾**: Frank Ocean『Blonde』(2016) — 全17曲 … 🔄 **進行中**(#1〜#3 制作済み・音声化待ち)
...
| # | 曲名 | ステータス | メモ |
|---|------|-----------|------|
| 1 | Nikes | 🔄 | 制作済み・音声化待ち / #1。シリーズ導入(Endless→契約満了→翌日に自主リリース、Apple独占、Billboard 200初登場1位、グラミー不出品、Blond/Blondeの二重表記)。冒頭の極端に高い声と「自分には二つのバージョンがある」という趣旨の宣言。スニーカーの名を題にした物欲の歌の途中でA$AP Yams(2015没)・Pimp C(2007没)・Trayvon Martin(2012年射殺、17歳)の名が呼ばれる=欲しかったものといなくなった人が同じ引き出しにある。MVはTyrone Lebon監督、2015-04ロンドン撮影、2016-08-20公開(16か月寝かされた)。ホームページの案内を一言 |
| 2 | Ivy | 🔄 | 制作済み・音声化待ち / #2。軽く歪んだギター一本と控えめなドラム。Malay共作、Om'Mas Keith＋Rostam Batmanglij(元Vampire Weekend、編曲も)制作、Jamie xxの関与も伝わる。#1の加工声の直後に素の声を置く順番設計=「二つのバージョン」の実演。初恋を壊れたあとに振り返る歌。2012年の本人のTumblr投稿(19歳の夏の初恋の相手が男性)には触れつつ、作品側は相手を特定しないので断定しない。終盤で声が歪んで壊れる結末=素の声で持ちこたえられなくなった瞬間の記録(Kraftwerkと逆向きの加工) |
| 3 | Pink + White | 🔄 | 制作済み・音声化待ち / #3。Pharrell Williamsと共作・共同プロデュース、ただし仕掛けをほぼ使わない抑制。簡素なピアノと歩くベース。クライマックスにクレジットなしのBeyoncéの背景ヴォーカル=同じ2016年に『Lemonade』(第3弾、4月)を出した人が4か月後に名前を脱いで参加(グラミー不出品と同じ態度)。題名は桃色から白へ抜ける夕空=終わりの近い美しさ、死すべきさだめ。ニューオーリンズ育ちで2005年カトリーナ後にLAへ移った経歴を、断定を避けつつ重ねる。3曲の設計=高い声/素の声と壊れる声/匿名の声 |
| 4 | Be Yourself | ⬜ | 留守番電話の音声によるインタールード |
| 5 | Solo | ⬜ |  |
| 6 | Skyline To | ⬜ |  |
| 7 | Self Control | ⬜ |  |
| 8 | Good Guy | ⬜ |  |
